---
"@devground/logger": minor
"@devground/ui-conventions": minor
"@devground/chile-formats": patch
"@devground/dreaming": patch
"@devground/design-taste": patch
"@devground/swift-ci": patch
"@devground/swift-design-tokens": patch
"@devground/swift-format-config": patch
"@devground/swift-package-template": patch
---

Cierra el ciclo de 8 semanas del ADR-0026 con veredicto para los 11 experimentales (ADR-0032).
