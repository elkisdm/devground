...
**Sí aplica, y se ejecutó como parte de este ejercicio**: ver [docs/adr/](../docs/adr/) — los 5 ADRs propios del repo documentan pnpm, Changesets, ESLint Flat Config, TypeScript strict y Husky.

Esta es la sección de la guía que más valor aporta a un proyecto de tooling. Las decisiones técnicas (qué bundler, qué versionado, qué linter) son **exactamente** las que se olvidan o se cuestionan 6 meses después.
...
| Paso 6 — Documentar | **Sí, alto valor** (motivó los 5 ADRs propios) |
...
3. **Reforzar Paso 6** como universalmente valioso — incluso un proyecto trivial se beneficia de 3-5 ADRs.
...
La guía **pasa el test ácido** con honestidad: aplica donde tiene sentido, no aplica donde no, y produjo valor concreto (5 ADRs reales en `docs/adr/`). El ejercicio también reveló mejoras menores, lo cual es exactamente el feedback que se buscaba.
